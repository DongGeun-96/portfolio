...
<head>
    ...
    <title>테일즈런너RPG, 지금 사전예약 중</title>

    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-SBH7E0BR0N"></script>
    <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'G-SBH7E0BR0N');
    </script>
...
<body>
            ...
            <div id="fullpage" class="bg2">
                ...
                <div class="section bg2 active" id="section1">
                    ...
                    <div class="section01Cotent">
                        ...
                        <button id="reserindexCbt" class="reserindexCbt bg"></button>
                        <div class="appbutBox">
                ...
                <!-- 사전예약 -->
                <div class="section resersection bg2" id="section1_1">

                    <ul class="reserNav nav nav-pills" id="reser-tab" role="tablist">
                        <!-- 사전예약 신청 -->
                        <li class="nav-item" role="presentation">
                            <button class="nav-link reser-apply active" data-bs-toggle="pill" data-bs-target="#reser-apply" aria-selected="true">사전예약 신청</button>
                        </li>
                        <!-- 스토어 사전예약 보상 -->
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" data-bs-toggle="pill" data-bs-target="#reser-present" aria-selected="false">스토어 사전예약 보상</button>
                        </li>
                    </ul>

                    <div class="tab-content" id="pills-reserContent">

                        <!-- 사전예약 신청 -->
                        <div class="tab-pane show active" id="reser-apply" role="tabpanel">
                            <div class="reserTab01 bg">
                                <div class="reserTab01-content">
                                    <div class="reserTab01-titlebox">
                                        <div class="reserTab01-title bg"></div>
                                        <p class="reserTab01-title02">
                                            사전 예약 기간 : 2024년 7월 22일 ~ 정식 오픈 전까지
                                        </p>
                                    </div>
                                    <div class="reserTab01Card bg">
                                        <!-- 입력 -->
                                        <div class="applyContent-left">
                                            <div class="applyContent-left-Content">
                                                <!-- 라디오 박스 -->
                                                <div class="applyContent-div01">
                                                    <div style="width:100%; text-align:center;">
                                                        <div class="appdivboxContent">
                                                            <div class="appdivbox">
                                                                <input type="radio" id="gooleRadio" name="attend" value="gooleRadio" checked="" onclick="updateRadioImage()">
                                                                <div class="appradiobutdiv" onclick="checkRadio('gooleRadio')">
                                                                    <img class="appradio" src="/images/appradioOn.png" alt="">
                                                                </div>
                                                                <label for="gooleRadio"><img style="width:100px;" src="/images/gooleRadio.png" alt=""></label>
                                                            </div>
                                                            <div class="appdivbox">
                                                                <input type="radio" id="appleRadio" name="attend" value="appleRadio" onclick="updateRadioImage()">
                                                                <div class="appradiobutdiv" onclick="checkRadio('appleRadio')">
                                                                    <img class="appradio" src="/images/appradio.png" alt="">
                                                                </div>
                                                                <label for="appleRadio"><img style="width:86px; margin-top:-2px;" src="/images/appleRadio.png" alt=""></label>
                                                            </div>
                                                        </div>
                                                        <input type="text" class="phoneinput" id="res_hp" placeholder="‘-’없이 휴대전화번호 입력">
                                                        <div class="pillcheckContent">
                                                            <div class="allagreeBox">
                                                                <div class="dis-ali">
                                                                    <input class="form-check-input" type="checkbox" id="selectAll" onclick="toggleAllCheckboxes(this)">
                                                                    <label class="allplusinput" for="selectAll" style="margin-bottom:-5px; font-weight:600;">모두 동의</label>
                                                                </div>
                                                                <button data-bs-toggle="modal" data-bs-target="#reser-warnagree" class="reseryou-plus">※사전예약 유의사항</button>
                                                            </div>
                                                            <div class="pill-sangCheck">
                                                                <div class="dis-ali">
                                                                    <input class="form-check-input" type="checkbox" id="check1" name="agreement" value="Y">
                                                                    <label for="check1">[필수] 만 15세 이상입니다.</label>
                                                                </div>
                                                                <div class="dis-ali-jus mt10">
                                                                    <div class="dis-ali">
                                                                        <input class="form-check-input" type="checkbox" id="check2" name="agreement" value="Y">
                                                                        <label for="check2">[필수] 개인정보 수집 / 이용 동의</label>
                                                                    </div>
                                                                    <button class="morebut" data-bs-toggle="modal" data-bs-target="#reser-useagree">자세히보기</button>
                                                                </div>
                                                                <div class="dis-ali-jus mt10">
                                                                    <div class="dis-ali">
                                                                        <input class="form-check-input" type="checkbox" id="check3" name="agreement" value="Y">
                                                                        <label for="check5">[필수] 이벤트 등 프로모션 알림 수신동의</label>
                                                                    </div>
                                                                    <button class="morebut" data-bs-toggle="modal" data-bs-target="#reser-eventpromt">자세히보기</button>
                                                                </div>
                                                                <!-- <div class="dis-ali-jus mt10">
                                                                    <div class="dis-ali">
                                                                        <input class="form-check-input" type="checkbox" id="check3" name="agreement" value="agree3">
                                                                        <label for="check3">[필수] 테일즈런너 RPG 정보 수신 동의</label>
                                                                    </div>
                                                                    <button class="morebut" data-bs-toggle="modal" data-bs-target="#reser-rpgagree">자세히보기</button>
                                                                </div> -->
                                                                <!-- <div class="dis-ali-jus mt10">
                                                                    <div class="dis-ali">
                                                                        <input class="form-check-input" type="checkbox" id="check4" name="agreement" value="agree4">
                                                                        <label for="check4">[선택] 광고성 정보 수신 동의</label>
                                                                    </div>
                                                                    <button class="morebut" data-bs-toggle="modal" data-bs-target="#reser-adagree">자세히보기</button>
                                                                </div> -->
                                                            </div>
                                                        </div>
                                                        <!-- <button class="reserinpuBut bg" data-bs-toggle="modal" data-bs-target="#reserModal"></button> -->
                                                        <button class="reserinpuBut bg" onclick="javascript:fncRes();"></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <!-- 스토어 사전예약 보상 -->
                        <div class="tab-pane" id="reser-present" role="tabpanel">
                            <div class="reserTab02 bg">
                                <div class="reserTab02-content">
                                    <div class="reserTab01-titlebox">
                                        <div class="reserTab01-title bg"></div>
                                        <p class="reserTab01-title02">
                                            사전 예약 기간 : 2024년 7월 22일 ~ 정식 오픈 전까지
                                    ...
                                    <div class="reserTab02Card bg">

                                        <div class="Presentdiv">
                                            <div class="showPresentdiv">
                                                <button id="showButton">
                                                    <img class="animated-image" src="/mobile/images/presentgif.png" alt="">
                                                </button>
                                                <div class="presentgifTitle bg"></div>
                                            </div>
                                            <div class="hidePresentdiv">
                                                <button id="backButton">
                                                    <img style="width:22px" src="/mobile/images/backButton.png" alt="뒤로가기">
                                                    <span>뒤로</span>
                                                </button>
                                                <div>
                                                    <div class="hidePresentdiv-content bg"></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="appbutBox">
                                ...
                                <!-- 꽃 -->
                                <div class="reserTab02Card-flower bg"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <!-- 이벤트 -->
                <div class="section eventsection bg2" id="section1_2">
                    <div class="eventsectionContent">
                        <div class="eventSection-titlebox">
                            <div class="eventSection-title bg"></div>
                            <p class="eventSection-title02">
                                사전 예약 기간 : 2024년 7월 22일 ~ 정식 오픈 전까지
                            </p>
                        </div>
                        <div class="eventgiftBoxDiv">
                            <ul>
                                <li>
                                    <div class="eventgiftBox event-gift01 bg"></div>
                                </li>
                                <li>
                                    <div class="eventgiftBox event-gift02 bg"></div>
                                </li>
                                <li>
                                    <div class="eventgiftBox event-gift03 bg"></div>
                                </li>
                            </ul>
                            <ul>
                                <li>
                                    <div class="eventgiftBox event-gift04 bg"></div>
                                </li>
                                <li>
                                    <div class="eventgiftBox event-gift05 bg"></div>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="eventMing bg"></div>
                </div>
                ...
                <div class="fllMenuContent-div">
                    <ul class="golink-ul">
                        <li>
                            <button id="MenubtnToSection1" class="reserlink reserlink-but">
                        ...
                        <li>
                            <button id="MenubtnToSection2" class="eventlink eventlink-but">
                                <div class="glowarrow-left">
                                    <img style="width:26px;" src="/mobile/images/glowarrow-left.png" alt="왼쪽 화살">
                                </div>
                                <span>이벤트</span>
                    ...
                    <div class="fllMenuContent-bottom">
                        ...
                        <ul class="copyul">
                            <li>상호 : (주) 라온 엔터테인먼트 &nbsp;|&nbsp; 사업자등록번호 : <span class="safa">514-81-37077</span></li>
    ...
    <!-- 사전예약 모달 -->
    <div class="modal fade mobile-almodal" id="reserModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div>
                        <!-- 사전예약 신청 완료 -->
                        <!-- <img  src="/mobile/images/reser-completeModal.png" alt="사전예약 신청 완료"> -->

                        <!-- 항목 모두 동의 -->
                        <!-- <img  src="/mobile/images/reser-completeModal01.png" alt="항목 모두 동의"> -->

                        <!-- 휴대폰 번호 입력 -->
                        <img src="/mobile/images/reser-completeModal02.png" alt="휴대폰 번호 입력">

                        <!-- 사전예약 신청 완료 -->
                        <!-- <img  src="/mobile/images/reser-completeModal03.png" alt="사전예약 신청 완료"> -->

                        <!-- os를 선택해주세요 -->
                        <!-- <img  src="/mobile/images/reser-completeModal04.png" alt="os를 선택해주세요"> -->

                        <button data-bs-dismiss="modal" class="reser-completeModalbutton bg"></button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- 사전예약 유의사항 -->
    <div class="modal fade mobile-almodal" id="reser-warnagree" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <button type="button" class="btn-close bg" data-bs-dismiss="modal" aria-label="Close"></button>
                <div class="modal-body">
                    <div>
                        <img src="/mobile/images/reser-warnagree.png" alt="사전예약 유의사항">
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- 개인정보 수집 / 이용 동의 -->
    <div class="modal fade mobile-almodal" id="reser-useagree" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <button type="button" class="btn-close bg" data-bs-dismiss="modal" aria-label="Close"></button>
                <div class="modal-body">
                    <div>
                        <img src="/mobile/images/reser-useagree.png" alt="개인정보 수집 / 이용 동의">
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- [필수] 이벤트 등 프로모션 알림 수신동의 -->
    <div class="modal fade mobile-almodal" id="reser-eventpromt" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <button type="button" class="btn-close bg" data-bs-dismiss="modal" aria-label="Close"></button>
                <div class="modal-body">
                    <div>
                        <img src="/mobile/images/reser-eventpromt.png" alt="[필수] 이벤트 등 프로모션 알림 수신동의">
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- 테일즈런너 RPG 정보 수신 동의 -->
    <div class="modal fade mobile-almodal" id="reser-rpgagree" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <button type="button" class="btn-close bg" data-bs-dismiss="modal" aria-label="Close"></button>
                <div class="modal-body">
                    <div>
                        <img src="/mobile/images/reser-rpgagree.png" alt="테일즈런너 RPG 정보 수신 동의">
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- 광고성 정보 수신 동의 -->
    <div class="modal fade mobile-almodal" id="reser-adagree" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <button type="button" class="btn-close bg" data-bs-dismiss="modal" aria-label="Close"></button>
                <div class="modal-body">
                    <div>
                        <img src="/mobile/images/reser-adagree.png" alt="광고성 정보 수신 동의">
                    </div>
                </div>
            </div>
        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function changeSection(next) {
            ...
            if (currentSection === 3 && next === 4 && !allowDirectTransition) return;
            if ((currentSection >= 4 && currentSection <= 5) && !allowDirectTransition) return;
        ...
        document.getElementById('MenubtnToSection1').addEventListener('click', function() {
            allowDirectTransition = true;
            changeSection(1);
            removeClasses();
        ...
        document.getElementById('reserindexCbt').addEventListener('click', function() {
            allowDirectTransition = true;
            changeSection(1);
            removeClasses();
            this.classList.add('butActive');
        ...
        document.getElementById('MenubtnToSection2').addEventListener('click', function() {
            allowDirectTransition = true;
            changeSection(2);
            removeClasses();
            this.classList.add('butActive');
        ...
        document.getElementById('MenubtnToSection3').addEventListener('click', function() {
            allowDirectTransition = true;
            changeSection(4); // 섹션 인덱스를 4로 변경 (3번 섹션이 이제 4번째)
            removeClasses();
            this.classList.add('butActive');
        });
        ...
        document.getElementById('MenubtnToSection4').addEventListener('click', function() {
            allowDirectTransition = true;
            changeSection(5); // 섹션 인덱스를 5로 변경 (4번 섹션이 이제 5번째)
            removeClasses();
            this.classList.add('butActive');
        });
        ...
        document.getElementById('MenubtnToSection5').addEventListener('click', function() {
            allowDirectTransition = true;
            changeSection(6); // 섹션 인덱스를 6로 변경 (5번 섹션이 이제 6번째)
            removeClasses();
            this.classList.add('butActive');
        });
        ...
        window.addEventListener('wheel', function(event) {
            ...
            } else if (!allowDirectTransition && (currentSection === 3 && event.deltaY > 0)) {
                return;
            } else if (currentSection === sections.length - 1) {
                return; // 마지막 섹션에서 위아래 스크롤 방지
            } else {
        ...
        window.addEventListener('touchend', function(event) {
            if (!isMenuOn() && !isModalShown()) {
                ...
                if (currentSection === 3 && deltaY > 30) {
                    return; // 4번째 인덱스에서 아래로 스크롤 방지
                } else if (currentSection === sections.length - 1) {
                    return; // 마지막 섹션에서 위아래 스크롤 방지
                } else {
                    if (deltaY > 30) {
...
<!-- 햄버거 메뉴에서 상황별 사전예약 효과 온오프 -->
<script>
    const resersection = document.querySelector('.resersection');

    // wordlink 클래스를 가진 모든 div 요소를 선택
    const reserlinks = document.querySelectorAll('.reserlink');

    // Observer 인스턴스를 생성하고, 변화를 감지할 콜백 함수를 정의
    const observerReser = new MutationObserver(mutations => {
        mutations.forEach(mutation => {
            if (mutation.attributeName === 'class') {
                ...
                if (target.classList.contains('active')) {
                    ...
                    reserlinks.forEach(reserlink => {
                        reserlink.classList.add('butActive');
                    });
                } else {
                    // active 클래스가 제거되면 butActive 클래스도 제거
                    reserlinks.forEach(reserlink => {
                        reserlink.classList.remove('butActive');
                    });
                }
            }
        });
    ...
    observerReser.observe(resersection, {
        attributes: true,
        attributeFilter: ['class']
    });
</script>

<!-- 햄버거 메뉴에서 상황별 이벤트 효과 온오프 -->
<script>
    ...
    // Observer 인스턴스를 생성하고, 변화를 감지할 콜백 함수를 정의
    const observerEvent = new MutationObserver(mutations => {
        mutations.forEach(mutation => {
            if (mutation.attributeName === 'class') {
                const target = mutation.target;
                if (target.classList.contains('active')) {
                    ...
                    eventlinks.forEach(eventlink => {
                        eventlink.classList.add('butActive');
                    });
                } else {
                    // active 클래스가 제거되면 butActive 클래스도 제거
                    eventlinks.forEach(eventlink => {
                        eventlink.classList.remove('butActive');
                    });
                }
            }
        });
...
<script>
    ...
    // observer를 설정하고, class 속성의 변화를 감지
    observer02.observe(peoplesection, {
        attributes: true,
        attributeFilter: ['class']
    });
</script>
...
<script>
    ...
    // observer를 설정하고, class 속성의 변화를 감지
    observer03.observe(mediasection, {
        attributes: true,
        attributeFilter: ['class']
    });
</script>
    ...
    var menuSwiper = new Swiper(".menuSwiper", {
        ...
        on: {
            init: function() {
                ...
                if (progressBarFill) {
                    progressBarFill.style.transform = 'scaleX(0.5)'; // 초기 프로그래스바를 두 번째 슬라이드에 맞게 설정
                }

                var newClassDiv = document.querySelector('.new-class');
                if (newClassDiv) {
                    newClassDiv.style.left = `calc(50% - ${newClassDiv.offsetWidth / 2}px)`; // 'new-class' 요소 위치 초기 설정
                }
            },
...
<script>
    function updateRadioImage() {
        // 모든 appradio 이미지를 기본 경로로 설정
        document.querySelectorAll('.appradio').forEach(function(img) {
            img.src = '/images/appradio.png';
        });

        // 선택된 라디오 버튼의 이미지를 변경
        const selectedRadio = document.querySelector('input[name="attend"]:checked');
        if (selectedRadio) {
            const selectedImage = selectedRadio.nextElementSibling.querySelector('.appradio');
            if (selectedImage) {
                selectedImage.src = '/images/appradioOn.png';
            }
        }
    }
    ...
    // 페이지 로드 시 초기 이미지 업데이트
    document.addEventListener('DOMContentLoaded', updateRadioImage);
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const showPresentdiv = document.querySelector('.showPresentdiv');
        const hidePresentdiv = document.querySelector('.hidePresentdiv');

        showButton.addEventListener('click', function() {
            showPresentdiv.style.opacity = 0;
            setTimeout(() => {
                showPresentdiv.style.display = 'none';
                hidePresentdiv.style.display = 'block';
                setTimeout(() => {
                    hidePresentdiv.style.opacity = 1;
                }, 10);
            }, 500);
        });

        backButton.addEventListener('click', function() {
            hidePresentdiv.style.opacity = 0;
            setTimeout(() => {
                hidePresentdiv.style.display = 'none';
                showPresentdiv.style.display = 'block';
                setTimeout(() => {
                    showPresentdiv.style.opacity = 1;
                }, 10);
            }, 500);
        });
    });
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        observer02.observe(menuButton02, {
            attributes: true
        });
...
<script>
    ...
    mediaVideoswiper.on('slideChange', function () {
            var iframes = document.querySelectorAll('.swiper-slide iframe');
            iframes.forEach(function (iframe) {
                var src = iframe.src;
                iframe.src = '';
...
<script>
    ...
    // Observer 설정
    observerVoice.observe(section4, {
        attributes: true
    });
    document.querySelectorAll('.tab-pane.active').forEach(targetNode => {
        ...
        // 감시할 대상 요소 및 설정
        observerTab.observe(targetNode, {
            attributes: true
        });
    });
</script>
...
$(function(){
    $.ajax({
        type:"GET"
        ,url:"/get.reserv_cnt.php"
        ,dataType:"JSON"
        ,success:function(res){
            if(res.result = "success"){
                let _reserv_cnt = res.reserv_cnt;
                $(".eventgiftBoxDiv > ul > li").each(function(i){
                    var k = i+1;
                    if(k <= _reserv_cnt){
                        $(this).find("div").addClass("event-gift-end");
                    }                    
                });
            }
        },error:function(e){
    ...
    $(".reserinpuBut").on("click",function(){
        gtag('event’, ‘user_preregist',{ 'event_label' : '사전등록완료',  });
    });
});
</script>