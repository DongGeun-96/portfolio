        ...
        <div id="contentbox">
            ...
            <div id="fullpage" class="bg2">
                ...
                <div class="section bg2 active" id="section1">
                    <div class="sectionVideobg section02Bg section01Bg">
                        <video loop muted autoplay playsinline>
                            <source src="/mobile/video/section01Bg.mp4" type="video/mp4">
                        </video>
                    </div>
                    <div class="section01Cotent">
                        ...
                        <!-- <button onclick="fncCBTCall();" class="indexCbt bg"></button> -->
                        <div class="indexScrolldown bg"></div>
                    </div>
                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function changeSection(next) {
            ...
            if ((currentSection === 2 || currentSection === 3 || currentSection === 4) && !allowDirectTransition) return;
...
<script>
   document.addEventListener("DOMContentLoaded", function() {
    ...
    shareButton02.addEventListener("click", function() {
        const urlToCopy = "https://trcbt.migoweb.co.kr/?medialink=2";
    ...
    shareButton03.addEventListener("click", function() {
        const urlToCopy = "https://trcbt.migoweb.co.kr/?medialink=3";
    ...
    shareButton04.addEventListener("click", function() {
        const urlToCopy = "https://trcbt.migoweb.co.kr/?medialink=4";
