...
<div class="wrapper <?php echo ($is_layout) ? $is_layout : 'wided'; ?>">
	<div id="nt_header">
		...
		<div id="nt_sticky">
			...
			<!-- LNB 시작 { -->
			<aside id="nt_lnb" class="disnone d-none d-md-block f-sm font-weight-normal">
					...
					<div class="px-3 px-sm-4">
						<h3 class="clearfix text-center f-mo font-weight-bold en">
							<a href="javascript:;" onclick="sidebar('menu');" class="float-left">
								<iconify-icon icon="heroicons-outline:menu" style="color:#fff; font-size:26px; margin-bottom:-6px;"></iconify-icon>
								<span class="sr-only">메뉴</span>
							</a>
							<div class="float-right">
								<a data-toggle="collapse" href="#search_mo" aria-expanded="false" aria-controls="search_mo" class="ml-3">
									<iconify-icon icon="ion:search" style="color:#fff; font-size:23px; margin-bottom:-6px;"></iconify-icon>
									<span class="sr-only">검색</span>
								</a>
							</div>
							<!-- Mobile Logo -->
							<a href="<?php echo NT_HOME_URL ?>">
								<img id="logo_img" src="https://www.toto-wiki.com/theme/BS4-Basic/img/logo.png" alt="토토위키" title="">
							</a>
						</h3>
					</div>
						...
						<div class="mb-0 p-3 px-sm-4 d-block d-lg-none border-bottom">
							...
							<input type="hidden" name="sop" value="and">
								<div class="input-group">
									<input id="mo_top_search" type="text" name="stx" class="form-control mo-searchbut-input" value="<?php echo $stx ?>" placeholder="검색어">
									<span class="input-group-append">
										<button type="submit" class="btn mo-searchbut"><i class="fa fa-search"></i></button>
									</span>
								</div>
							</form>
						</div>
