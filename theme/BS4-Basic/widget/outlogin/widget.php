...
<div class="f-de font-weight-normal">
	...
	<?php if($is_member) { //Login ?>
		...
		<div class="btn-group w-100 greengroup" role="group" aria-label="Member Menu">
			<a href="javascript:;" onclick="sidebar('user')" class="btn text-white" role="button">
				내정보
			</a>
			<a href="javascript:;" onclick="sidebar('noti')" class="btn  text-white" role="button">
			...
			<a href="<?php echo G5_BBS_URL ?>/logout.php" class="btn  text-white" role="button">
				로그아웃
			</a>
		</div>
