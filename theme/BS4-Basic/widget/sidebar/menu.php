...
<div id="nt_sidebar_menu" class="sidebar-list">
	<!-- <div class="hamevent">
		<a href="#">
			<img class="w100" src="/theme/BS4-Basic/img/sideevent.webp" alt="이벤트">
		</a>
	</div> -->
	<h5 class="f-de" style="font-weight:400 !important;">메뉴</h5>
	<ul class="me-ul f-de">
...
<div class="p-3 pb-5 border-top peopleside" style="margin-top:-1px;">
