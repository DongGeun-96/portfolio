...
.view-comment .view-comment-item {position:relative;padding:0 0 20px;border-bottom:1px solid #ccc !important;margin-top:10px;}
...
.comment-area .comment-write .comment-write-footer {position:relative;background:#272b2e;border-top:0;padding:15px;color:#959595;font-size:.8125rem}
.comment-area .comment-write-submit {position:relative;text-align:center}
.comment-area #modal_comment_video_note .table-list-eb .table thead>tr>th {text-align:left}
.comment-area .view-comment-more {text-align:center;border-top:1px solid #e5e5e5;padding-top:30px;margin-bottom:40px}
.comment-area .eyoom-form .textarea {margin-bottom:0}
.comment-area .eyoom-form .textarea textarea {border:1px solid #d5d5d5;background:#000 !important;}
