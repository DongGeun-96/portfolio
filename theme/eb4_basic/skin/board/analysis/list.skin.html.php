        ...
        <div class="bl-wrap board-sport-wrap">
            <div class="<?php if ($list[$i]['is_notice']) { ?>bl-notice<?php } ?>">
                <div class="newscontent">
                    <div class="sportteach">
                        <?php
                        for ($i = 0; $i < count((array)$list); $i++) {
                            $file_arr = get_file($bo_table, $list[$i]['wr_id']);
                        ?>
                        <a href="<?php echo $list[$i]['href']; ?>" class="sportteachbox">
                            <p class="sportteachbox-day">08월 23일 (금) 17:00 · 조회수 20 · 추천 45 </p>
                            <div class="sportteachbox-box">
                                <div class="sportteachbox-box-left">
                                    ...
                                    <div class="sportteachbox-box-left-01">
                                        ...
                                        <div>
                                            <img class="teachimg" src="<?php echo $file_arr[1]['path']."/".$file_arr[1]['file'];?>" alt="팀">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="sportteachbox-box-right">
                                    <div class="sportteachbox-box-right-01">
                                        <div>
                                            <img class="teachimg" src="<?php echo $file_arr[0]['path']."/".$file_arr[0]['file'];?>" alt="팀">
                                        </div>
                                        <span class="teachteamname">소프트뱅크</span>
                                    </div>
    ...
    <script>
        $(function() {
            $(".btn_favorite_toggle").change(function() {
                ...
                $.post('<?php echo EYOOM_CORE_URL; ?>/board/favorite_board.php', {
