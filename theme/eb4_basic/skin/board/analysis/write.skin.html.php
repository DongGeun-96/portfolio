...
.eyoom-form .checkbox, .eyoom-form .radio {color:#fff;}
</style>
...
<div class="board-write">
    ...
    <section>
        <div class="row">
            <div class="col col-4">
                <label for="wr_1" class="label">홈 팀명</label>
                <label class="input required-mark">
                    <input type="text" name="wr_1" id="wr_1" value="<?php echo $write['wr_1']?>" required>
                </label>
            </div>
            <div class="col col-4">
                <label for="wr_2" class="label">원정 팀명</label>
                <label class="input required-mark">
                    <input type="text" name="wr_2" id="wr_2" value="<?php echo $write['wr_2']?>" required>
                </label>
            </div>
            <div class="col col-4">
                <label for="wr_6" class="label">경기 일정</label>
                <label class="input required-mark">
                    <input type="text" name="wr_6" id="wr_6" value="<?php echo $write['wr_6']?>" required placeholder="ex) 07/26(금) 18:00">
                </label>
            </div>
        </div>
    </section>
    <section>
        <div class="row">
            <div class="col col-4">
                <label class="label">승무패</label>
                <label class="radio">
                    <input type="radio" name="wr_3" value="1"<?php echo ($write['wr_3']!="2")? " checked":""?>><i></i>홈
                </label>
                <label class="radio">
                    <input type="radio" name="wr_3" value="2"<?php echo ($write['wr_3']=="2")? " checked":""?>><i></i>원정
                </label>
                <label class="radio">
                    <input type="radio" name="wr_3" value="3"<?php echo ($write['wr_3']=="3")? " checked":""?>><i></i>무
                </label>
            </div>
        </div>
    </section>
    <section>
        <div class="row">
            <div class="col col-4">
                <label for="wr_4" class="label">핸디캡</label>
                <label class="radio">
                    <input type="radio" name="wr_4" value="1"<?php echo ($write['wr_4']!="2")? " checked":""?>><i></i>홈
                </label>
                <label class="radio">
                    <input type="radio" name="wr_4" value="2"<?php echo ($write['wr_4']=="2")? " checked":""?>><i></i>원정
                </label>
            </div>
            <div class="col col-4">
                <label for="ex_1" class="label">핸디</label>
                <label class="input">
                    <input type="text" name="ex_1" id="ex_1" value="<?php echo $ex_value['ex_1']; ?>" <?php echo $exinfo['ex_required'] == 'y' ? 'required': ''; ?>>
                </label>
            </div>
        </div>
    </section>
    <section>
        <div class="row">
            <div class="col col-4">
                <label for="wr_5" class="label">오버/언더</label>
                <label class="radio">
                    <input type="radio" name="wr_5" value="1"<?php echo ($write['wr_5']!="2")? " checked":""?>><i></i>오버
                </label>
                <label class="radio">
                    <input type="radio" name="wr_5" value="2"<?php echo ($write['wr_5']=="2")? " checked":""?>><i></i>언더
                </label>
            </div>
            <div class="col col-4">
                <label for="ex_2" class="label">기준점</label>
                <label class="input">
                    <input type="text" name="ex_2" id="ex_2" value="<?php echo $ex_value['ex_2']; ?>" <?php echo $exinfo['ex_required'] == 'y' ? 'required': ''; ?>>
                </label>
            </div>
        </div>
    </section>
    <!-- <section>
        <div class="row">
            <div class="col col-12">
                <label class="label">홈팀 설명</label>
                <label class="textarea">
                    <textarea name="wr_7" id="wr_7" style="height:100px;"><?php echo $write['wr_7']?></textarea>
                </label>
            </div>
        </div>
        <div class="row">
            <div class="col col-12">
                <label for="wr_4" class="label">원정팀 설명</label>
                <label class="textarea">
                    <textarea name="wr_8" id="wr_8" style="height:100px;"><?php echo $write['wr_8']?></textarea>
                </label>
            </div>
        </div>
    </section> -->
    ...
    <section>
        <div class="row">
            <div class="col col-12">
                <label for="bf_file_1" class="label">홈팀 로고 업로드</label>
                <label class="input">
                    <input type="file" class="form-control" id="bf_file_1" name="bf_file[]" value="사진선택">
                    <b class="tooltip tooltip-top-right">홈팀 로고 : 용량 <?php echo $upload_max_filesize; ?> 이하만 업로드 가능</b>
                </label>
            </div>
            <?php if ($w=='u' && $wr_file[0]['file']) { ?>
            <div class="col col-12 m-b-15">
                <label for="bf_file_del0" class="checkbox"><input type="checkbox" id="bf_file_del0" name="bf_file_del[0]" value="1"><i></i><?php echo $wr_file[0]['source'];?> (<?php echo $wr_file[0]['size']; ?>) 파일삭제</label>
            </div>
            <?php } ?>
        </div>
        ...
        <div class="row">
            <div class="col col-12">
                <label for="bf_file_2" class="label">원정팀 로고 업로드</label>
                <label class="input">
                    <input type="file" class="form-control" id="bf_file_2" name="bf_file[]" value="사진선택">
                    <b class="tooltip tooltip-top-right">원정팀 로고 : 용량 <?php echo $upload_max_filesize; ?> 이하만 업로드 가능</b>
                </label>
            </div>
            <?php if ($w=='u' && $wr_file[1]['file']) { ?>
            <div class="col col-12 m-b-15">
                <label for="bf_file_del0" class="checkbox"><input type="checkbox" id="bf_file_del1" name="bf_file_del[1]" value="1"><i></i><?php echo $wr_file[1]['source'];?> (<?php echo $wr_file[1]['size']; ?>) 파일삭제</label>
            </div>
            <?php } ?>
        </div>
    </section>
