...
.board-view .board-view-good-btn .board-view-act-gng .act-gng-btn {position:relative;overflow:hidden;width:80px;height:80px;border:1px solid #d5d5d5;display:inline-block;white-space:nowrap;vertical-align:baseline;text-align:center}
...
.board-view .board-view-good-btn .board-view-act-gng .act-gng-btn .mask {width:100%;height:100%;position:absolute;overflow:hidden;top:0;left:0;opacity:0}
...
<article class="board-view  dong-board-view">
    ...
    <div class="newsbig-top">
        ...
        <?php } ?>
        <div class="view-info-box" <?php if($config['cf_use_member_icon']) { ?>style=""<?php } ?>>
    ...
    <div class="board-view-atc" id="view_good_nogood">
        ...
        <div id="board_view_con" class="board-view-con view-content">
            <div class="sportteachbox sportteachbox02">
                <p class="sportteachbox-day">08월 23일 (금) 17:00</p>
                <div class="sportteachbox-box">
                    <div class="sportteachbox-box-left">
                        <span class="teamplace">홈</span>
                        <div class="sportteachbox-box-left-01">
                            <span class="teachteamname">소프트뱅크</span>
                            <div>
                                <img class="teachimg" src="<?php echo $view['file'][0]['path']."/".$view['file'][0]['file'];?>" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="sportteachbox-box-vs">
                        <span>VS</span>
                    </div>
                    <div class="sportteachbox-box-right">
                        <div class="sportteachbox-box-right-01">
                            <div>
                                <img class="teachimg" src="<?php echo $view['file'][1]['path']."/".$view['file'][1]['file'];?>" alt="">
                            </div>
                            <span class="teachteamname">소프트뱅크</span>
                        </div>
                        <span class="teamplace wonplace">원정</span>
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                ?>
                <div class="playday playday-sub">
                    <div class="playdaytop">
                    <p class="playvs">승무패</p>
                        <div class="playday-name playday-name-left">
                            <div class="playday-name-div">
                                <span><?php echo $wr_3_txt?></span>
                            </div>
                        </div>
                        <div class="playday-name playday-name-right">
                        </div>
                    </div>
                </div>
                <?php
                ...
                <div class="playday playday-sub">
                    <div class="playdaytop">
                        <p class="playvs">핸디캡</p>
                        <div class="playday-name playday-name-left">
                            <div class="playday-name-div">
                                <span><?php echo $wr_4_txt?></span>
                            </div>
                        </div>
                        <div class="playday-name playday-name-right">
                            <div class="playday-name-div">
                                <span><?php echo $ex_view['ex_1']['value']; ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="playday playday-sub">
                    <div class="playdaytop">
                        <p class="playvs">오버/언더</p>
                        <div class="playday-name playday-name-left">
                            <div class="playday-name-div">
                                <span><?php echo $wr_5_txt;?></span>
                            </div>
                        </div>
                        <div class="playday-name playday-name-right">
                            <div class="playday-name-div">
                                <span><?php echo $ex_view['ex_2']['value']; ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                <!-- <div class="playday">
                    <div class="playdaytop playdaytop-overbox">
                        <span class="bich02">오버</span>
                        <span class="bich02">2.5</span>
                        <span class="bich02 chou">추천</span>
                    </div>
                </div> -->
            </div>

            <!-- <div class="bunbox">
                <h4>부천 FC (대한민국 K리그2 9위)</h4>
                <ul>
                    <li>
                        <span>수비 약점</span> : 최근 경기들에서 수비적인 약점이 부각되고 있습니다. 매우 수비적인 상대팀을 상대로는 승리를 거두었으나, 공격적인 상대팀들과의 경기에서는 계속해서 득점을 허용하고 있습니다.
                    </li>
                    <li><span>배후 공간 활용</span> : 부천은 상대팀의 공격을 막아내며 배후 공간을 노려서 득점하는 능력이 뛰어납니다.</li>
                    <li><span>수원삼성 대비</span> : 수원삼성의 변화된 전략에서는 조심해야 할 부분이 있습니다.</li>
                </ul>
            </div>

            <div class="bunbox bunbox02">
                <h4>부천 FC (대한민국 K리그2 9위)</h4>
                <ul>
                    <li>
                        <span>수비 약점</span> : 최근 경기들에서 수비적인 약점이 부각되고 있습니다. 매우 수비적인 상대팀을 상대로는 승리를 거두었으나, 공격적인 상대팀들과의 경기에서는 계속해서 득점을 허용하고 있습니다.
            ...
            <div class="mt-4 bunsangContent">
                <?php echo $view_content; ?>
            </div>

            <div class="bunwarnbox bungsangburn">
                <ul>
                    <li>본 자료는 저작자의 개인적인 견해나 해석이 반영되어 있으며 정보 제공을 목적으로 합니다.</li>
                    <li>본 자료는 법률을 준수하고 건전한 게임 및 스포츠 관련 활동을 즐기는 것이 중요하다는 점을 강조합니다.</li>
                    <li>이 자료는 정보 제공을 목적으로 하며, 법률을 준수하고 윤리적인 행동을 바탕으로 하는 것을 촉구합니다.</li>
                </ul>
                <ul>
                    <li>[Copyright © 퍼스트티비., 무단전재 및 재배포 금지]</li>
                    <li>[본 분석자료는 퍼스트티비의 고유 자산입니다. 퍼스트티비 이외에 무단사용 및 재배포를 금지합니다.]</li>
                </ul>
            </div>
        </div>
